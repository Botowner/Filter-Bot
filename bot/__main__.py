...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Heya,{} Here..\nHow can I help you? 🙂".format(bot.first_name),reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="ʜᴇʟᴩ",url="t.me/{}?start=help".format(bot.username))]]))
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="ʜᴇʟᴩ",callback_data="help_back"),InlineKeyboardButton(text="ʙᴏᴛ ᴏᴡɴᴇʀ",url="https://t.me/Aswin_pm_Bot")]]
    keyboard += [[InlineKeyboardButton(text="ᴄᴏɴɴᴇᴄᴛ ɢʀᴏᴜᴩ", callback_data="main_connect"),InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ᴛᴏ ᴜʀ ɢʀᴏᴜᴘ",url="t.me/{}?startgroup=true".format(bot.username))]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="ᴏᴡɴᴇʀ",url="https://t.me/Aswin_pm_Bot")]]))
        return
